...
const Page1 = ({ isVisible }) => {
  return (
    <div>
      ...
      <div className=" justify-center items-center w-[400px] h-[50px] absolute rotate-90 text-[#ffff] lg:top-[200px]  lg:left-[130px]  md:top-[250px]  md:left-[-20px]  sm:top-[200px] sm:left-[-50px]  vvsm:top-[200px] vvsm:left-[-150px]  vsm:top-[250px] vsm:left-[-130px] ssm:left-[-130px] sm:text-[70px] vsm:text-[50px] vvsm:text-[40px] playfair">
        ELISE X GAL
      </div>
    </div>
  );
